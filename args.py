#script for parsing and processing command-line arguments for training/testing the STG-NF model
...
def init_sub_args(args):
    ...
    dataset = "UBnormal" if args.dataset == "UBnormal" else ("PoseLift" if args.dataset == "PoseLift" else "ShanghaiTech")
...
def args_rm_prefix(args, prefix): #Convert args with prefix to model args
